(() => {
  ...
  function init(){
    ...
    typeGrid?.addEventListener('click',e=>{const btn=e.target.closest('[data-type-filter]');if(btn&&!btn.disabled)openBrowser(btn.dataset.typeFilter);});
